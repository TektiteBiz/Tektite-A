...
class AltitudeEstimator {
  ...
  private:
    ...
    uint32_t previousTime = GetMicros();
...
extern "C" float getZAlt();
extern "C" float getZVel();
extern "C" float getZAccel();
extern "C" void estimate(float accel[3], float gyro[3], float baroHeight);
